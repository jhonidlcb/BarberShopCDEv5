...
export default function Admin() {
  ...
  const tabs = [
    ...
    { value: 'users', label: 'Usuarios', icon: Users, color: 'text-pink-400' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto py-4 sm:py-8 px-4 sm:px-6 lg:px-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          {/* Desktop Tabs */}
          <TabsList className="hidden lg:grid lg:grid-cols-6 bg-white/10 backdrop-blur-md border border-white/20 p-1">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
                <TabsTrigger 
              ...
              <CardHeader className="border-b border-white/10">
                <CardTitle className="flex items-center text-white">
                  <div className="relative mr-3">
                    ...
                    <div className="absolute -inset-1 bg-pink-500/20 rounded-full blur"></div>
                  </div>
                  Gestión de Usuarios
                </CardTitle>
                <CardDescription className="text-purple-200">
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="text-center py-12">
                  <div className="relative mx-auto w-20 h-20 mb-6">
                    <Users className="h-20 w-20 text-pink-400/50" />
                    <div className="absolute -inset-2 bg-pink-500/10 rounded-full blur"></div>
                  </div>
                  <h3 className="text-2xl font-semibold text-white mb-3">
                    Gestión de Usuarios
                  </h3>
                  <p className="text-purple-300 mb-6 max-w-md mx-auto">
                    Esta funcionalidad estará disponible próximamente. Podrás gestionar usuarios, roles y permisos.
                  </p>
                  <Badge variant="outline" className="text-pink-300 border-pink-400">
